...
struct UUMG_StatDisplay_C : UUserWidget {
	...
	void UpdateStats(); // Function UMG_StatDisplay.UMG_StatDisplay_C.UpdateStats // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1be0000
	void Tick(struct FGeometry MyGeometry, float InDeltaTime); // Function UMG_StatDisplay.UMG_StatDisplay_C.Tick // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1be0000
	void StatContainerUpdated(); // Function UMG_StatDisplay.UMG_StatDisplay_C.StatContainerUpdated // (BlueprintCallable|BlueprintEvent) // @ game+0x1be0000
	void ExecuteUbergraph_UMG_StatDisplay(int32_t EntryPoint); // Function UMG_StatDisplay.UMG_StatDisplay_C.ExecuteUbergraph_UMG_StatDisplay // (Final|UbergraphFunction|HasDefaults) // @ game+0x1be0000
};
