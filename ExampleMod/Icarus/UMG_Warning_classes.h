...
struct UUMG_Warning_C : UUserWidget {
	...
	void SetState(bool Visible); // Function UMG_Warning.UMG_Warning_C.SetState // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1be0000
	void Initialise(struct FText Reason); // Function UMG_Warning.UMG_Warning_C.Initialise // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1be0000
};
