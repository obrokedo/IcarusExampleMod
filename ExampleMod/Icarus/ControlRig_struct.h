...
struct FRigUnit_SphereTraceWorld : FRigUnit {
	...
	struct TArray<enum class ECollisionChannel> ResponseChannels; // 0x20(0x10)
	enum class ECollisionChannel Channel; // 0x30(0x01)
	char pad_31[0x3]; // 0x31(0x03)
	float Radius; // 0x34(0x04)
	bool bHit; // 0x38(0x01)
	char pad_39[0x3]; // 0x39(0x03)
	struct FVector HitLocation; // 0x3c(0x0c)
	struct FVector HitNormal; // 0x48(0x0c)
	char pad_54[0x4]; // 0x54(0x04)
};
