...
struct UBP_IcarusGOAPMotivation_Safety_C : UBP_IcarusGOAPMotivation_Base_C {
	...
	bool UpdateCost(float Delta, struct AIcarusNPCGOAPController* Controller); // Function BP_IcarusGOAPMotivation_Safety.BP_IcarusGOAPMotivation_Safety_C.UpdateCost // (Event|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1be0000
};
