...
struct UBTD_DistanceCheck_C : UBTDecorator_BlueprintBase {
	...
	bool PerformConditionCheck(struct AActor* OwnerActor); // Function BTD_DistanceCheck.BTD_DistanceCheck_C.PerformConditionCheck // (Event|Protected|HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1be0000
};
