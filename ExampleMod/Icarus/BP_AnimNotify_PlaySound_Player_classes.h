...
struct UBP_AnimNotify_PlaySound_Player_C : UAnimNotify_PlaySoundPlayer {
	...
	struct FString GetNotifyName(); // Function BP_AnimNotify_PlaySound_Player.BP_AnimNotify_PlaySound_Player_C.GetNotifyName // (Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent|Const) // @ game+0x1be0000
	bool Received_Notify(struct USkeletalMeshComponent* MeshComp, struct UAnimSequenceBase* Animation); // Function BP_AnimNotify_PlaySound_Player.BP_AnimNotify_PlaySound_Player_C.Received_Notify // (Event|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|Const) // @ game+0x1be0000
};
