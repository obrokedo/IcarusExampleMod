...
struct UUMG_ArmourSet_C : UUserWidget {
	...
	void Construct(); // Function UMG_ArmourSet.UMG_ArmourSet_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1be0000
	void ExecuteUbergraph_UMG_ArmourSet(int32_t EntryPoint); // Function UMG_ArmourSet.UMG_ArmourSet_C.ExecuteUbergraph_UMG_ArmourSet // (Final|UbergraphFunction|HasDefaults) // @ game+0x1be0000
};
