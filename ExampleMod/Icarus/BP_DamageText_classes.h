...
struct ABP_DamageText_C : AActor {
	...
	void ReceiveBeginPlay(); // Function BP_DamageText.BP_DamageText_C.ReceiveBeginPlay // (Event|Protected|BlueprintEvent) // @ game+0x1be0000
	void ExecuteUbergraph_BP_DamageText(int32_t EntryPoint); // Function BP_DamageText.BP_DamageText_C.ExecuteUbergraph_BP_DamageText // (Final|UbergraphFunction) // @ game+0x1be0000
};
