...
struct UUMG_RecipeElementTooltip_C : UUserWidget {
	...
	void UpdateHolographicPreview(struct FItemData Item, enum class ProcessorPreview PreviewState, enum class EIcarusResourceType ResourceType, int32_t CurrentAmount, int32_t RecipeMultiplier, bool Output); // Function UMG_RecipeElementTooltip.UMG_RecipeElementTooltip_C.UpdateHolographicPreview // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1be0000
};
