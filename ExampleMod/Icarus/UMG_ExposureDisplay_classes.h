...
struct UUMG_ExposureDisplay_C : UUserWidget {
	...
	void SetProgress(float Percent); // Function UMG_ExposureDisplay.UMG_ExposureDisplay_C.SetProgress // (BlueprintCallable|BlueprintEvent) // @ game+0x1be0000
	void Tick(struct FGeometry MyGeometry, float InDeltaTime); // Function UMG_ExposureDisplay.UMG_ExposureDisplay_C.Tick // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1be0000
	void ExecuteUbergraph_UMG_ExposureDisplay(int32_t EntryPoint); // Function UMG_ExposureDisplay.UMG_ExposureDisplay_C.ExecuteUbergraph_UMG_ExposureDisplay // (Final|UbergraphFunction|HasDefaults) // @ game+0x1be0000
};
