...
struct FResClaimProspect {
	bool Success; // 0x00(0x01)
	char pad_1[0x7]; // 0x01(0x07)
	struct FProspectInfo Prospect; // 0x08(0x88)
};
...
struct FResCreateCharacter {
	bool Success; // 0x00(0x01)
	char pad_1[0x7]; // 0x01(0x07)
	struct FOnlineProfileCharacter CreatedCharacter; // 0x08(0xa0)
};
...
struct FOnlineProfileCharacter {
	...
	struct FCharacterCosmetics Cosmetic; // 0x58(0x34)
	char pad_8C[0x4]; // 0x8c(0x04)
	struct TArray<struct FBackendTalent> Talents; // 0x90(0x10)
};
...
struct FCharacterCosmetics {
	int32_t Customization_Head; // 0x00(0x04)
	int32_t Customization_Hair; // 0x04(0x04)
	int32_t Customization_HairColor; // 0x08(0x04)
	int32_t Customization_Body; // 0x0c(0x04)
	int32_t Customization_BodyColor; // 0x10(0x04)
	int32_t Customization_SkinTone; // 0x14(0x04)
	int32_t Customization_HeadTattoo; // 0x18(0x04)
	int32_t Customization_HeadScar; // 0x1c(0x04)
	int32_t Customization_HeadFacialHair; // 0x20(0x04)
	int32_t Customization_CapLogo; // 0x24(0x04)
	bool IsMale; // 0x28(0x01)
	char pad_29[0x3]; // 0x29(0x03)
	int32_t Customization_Voice; // 0x2c(0x04)
	int32_t Customization_EyeColor; // 0x30(0x04)
};
...
struct FResExchangeCurrency {
	bool Success; // 0x00(0x01)
	char pad_1[0x7]; // 0x01(0x07)
	struct TArray<struct FMetaResource> CurrencyDeltas; // 0x08(0x10)
};
...
struct FResGetCharacterProfile {
	bool Success; // 0x00(0x01)
	char pad_1[0x7]; // 0x01(0x07)
	struct FOnlineProfileCharacter Character; // 0x08(0xa0)
};
...
struct FResGetLastProspect {
	bool Success; // 0x00(0x01)
	char pad_1[0x7]; // 0x01(0x07)
	struct FProspectInfo ProspectInformation; // 0x08(0x88)
	int32_t FactionMissionStatus; // 0x90(0x04)
...
struct FNotification {
	...
	struct FString ProspectID; // 0x38(0x10)
...
struct FResGetProspectReport {
	bool Success; // 0x00(0x01)
	char pad_1[0x7]; // 0x01(0x07)
	struct FProspectInfo ProspectInfo; // 0x08(0x88)
	struct FAttachment CurrentRewards; // 0x90(0x28)
};
...
struct FResGetProspectSummary {
	bool Success; // 0x00(0x01)
	char pad_1[0x7]; // 0x01(0x07)
	struct FProspectCompleteInformation ProspectInformation; // 0x08(0xf8)
};
...
struct FProspectCompleteInformation {
	...
	bool FactionMissionSuccessful; // 0x88(0x01)
	char pad_89[0x7]; // 0x89(0x07)
	struct FAttachment ProspectRewards; // 0x90(0x28)
	int64_t Duration; // 0xb8(0x08)
	struct FAttachment FactionMissionRewards; // 0xc0(0x28)
	struct TArray<struct FTrackedStat> TrackedStats; // 0xe8(0x10)
};
...
struct FResGetUserProfile {
	bool Success; // 0x00(0x01)
	char pad_1[0x7]; // 0x01(0x07)
	struct FOnlineProfileUser IcarusProfile; // 0x08(0x40)
};
...
struct FOnlineProfileUser {
	...
	struct TArray<int32_t> UnlockedFlags; // 0x20(0x10)
	struct TArray<struct FBackendTalent> Talents; // 0x30(0x10)
};
...
struct FResReplicateWorkshopItem {
	...
	char pad_1[0x7]; // 0x01(0x07)
	struct FInventoryDelta InventoryDelta; // 0x08(0x18)
	struct TArray<struct FMetaResource> CurrencyDelta; // 0x20(0x10)
};
...
struct FResResumeProspect {
	...
	struct FProspectInfo Prospect; // 0x18(0x88)
	struct FProspectBlob ProspectBlob; // 0xa0(0x40)
};
...
struct FResTalentRefund {
	bool Success; // 0x00(0x01)
	char pad_1[0x7]; // 0x01(0x07)
	struct FBackendTalent Talent; // 0x08(0x18)
	struct TArray<struct FMetaResource> CurrencyDelta; // 0x20(0x10)
};
...
struct FResUnlockWorkshopItem {
	bool Success; // 0x00(0x01)
	char pad_1[0x7]; // 0x01(0x07)
	struct FString UnlockedTalent; // 0x08(0x10)
	struct TArray<struct FMetaResource> CurrencyDelta; // 0x18(0x10)
};
...
struct FReqClaimProspect {
	...
	struct FProspectInfo Prospect; // 0x28(0x88)
};
...
struct FReqCreateCharacter {
	struct FString CharacterName; // 0x00(0x10)
	struct FCharacterCosmetics CharacterCosmeticsData; // 0x10(0x34)
...
struct FReqExchangeCurrency {
	struct FMetaResource StartingCurrencyDelta; // 0x00(0x18)
	struct FMetaResource EndingCurrencyDelta; // 0x18(0x18)
};

// ScriptStruct IcarusGenerated.ReqGenerateProspects
// Size: 0x10 (Inherited: 0x00)
struct FReqGenerateProspects {
	struct TArray<struct FString> ProspectDTKeys; // 0x00(0x10)
};
...
struct FReqReplicateWorkshopItem {
	struct FString UserID; // 0x00(0x10)
	struct FString WorkshopTalent; // 0x10(0x10)
};
...
struct FReqResumeProspect {
	struct FString ProspectID; // 0x00(0x10)
	int32_t ChrSlot; // 0x10(0x04)
	bool AttemptHostMigration; // 0x14(0x01)
...
struct FReqSettleProspect {
	struct FString UserID; // 0x00(0x10)
	struct FString ProspectID; // 0x10(0x10)
...
struct FReqSyncAccountTalents {
	struct FString UserID; // 0x00(0x10)
	struct TArray<struct FBackendTalent> Talents; // 0x10(0x10)
};
...
struct FReqTalentRefund {
	struct FBackendTalent Talent; // 0x00(0x18)
	int32_t CharacterSlot; // 0x18(0x04)
...
struct FReqUnlockAccountFlags {
	struct FString UserID; // 0x00(0x10)
	struct TArray<int32_t> UnlockedFlags; // 0x10(0x10)
};
...
struct FReqUnlockCharacterFlags {
	...
	int32_t ChrSlot; // 0x10(0x04)
	char pad_14[0x4]; // 0x14(0x04)
	struct TArray<int32_t> UnlockedFlags; // 0x18(0x10)
};
...
struct FReqUpdateCharacterProspectLocation {
	...
	struct FString UserID; // 0x10(0x10)
	int32_t ChrSlot; // 0x20(0x04)
	enum class EProspectLocation Location; // 0x24(0x01)
	char pad_25[0x3]; // 0x25(0x03)
};
...
struct FReqUpdateCosmetics {
	struct FString UserID; // 0x00(0x10)
	int32_t ChrSlot; // 0x10(0x04)
	struct FCharacterCosmetics CharacterCosmeticsData; // 0x14(0x34)
};
...
struct FReqUpdateProspect {
	...
	int32_t ElapsedTime; // 0x18(0x04)
	bool HasProspectBlob; // 0x1c(0x01)
