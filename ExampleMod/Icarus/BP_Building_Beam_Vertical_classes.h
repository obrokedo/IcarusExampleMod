...
struct ABP_Building_Beam_Vertical_C : ABP_Building_Beam_C {
	...
	void ReceiveBeginPlay(); // Function BP_Building_Beam_Vertical.BP_Building_Beam_Vertical_C.ReceiveBeginPlay // (Event|Protected|BlueprintEvent) // @ game+0x1be0000
	void ExecuteUbergraph_BP_Building_Beam_Vertical(int32_t EntryPoint); // Function BP_Building_Beam_Vertical.BP_Building_Beam_Vertical_C.ExecuteUbergraph_BP_Building_Beam_Vertical // (Final|UbergraphFunction) // @ game+0x1be0000
};
