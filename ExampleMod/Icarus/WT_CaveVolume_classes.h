...
struct AWT_CaveVolume_C : AActor {
	...
	void GetReportedScore(float& Score); // Function WT_CaveVolume.WT_CaveVolume_C.GetReportedScore // (Public|HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1be0000
	void UserConstructionScript(); // Function WT_CaveVolume.WT_CaveVolume_C.UserConstructionScript // (Event|Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1be0000
	...
	void ExecuteUbergraph_WT_CaveVolume(int32_t EntryPoint); // Function WT_CaveVolume.WT_CaveVolume_C.ExecuteUbergraph_WT_CaveVolume // (Final|UbergraphFunction|HasDefaults) // @ game+0x1be0000
};
