...
struct U3RD_MAL_RIG_BedAnimBP_C : UAnimInstance {
	...
	void VehicleLowerBody(struct FPoseLink LowerInPose, struct FPoseLink& VehicleLowerBody); // Function 3RD_MAL_RIG_BedAnimBP.3RD_MAL_RIG_BedAnimBP_C.VehicleLowerBody // (HasOutParms|BlueprintCallable) // @ game+0x1be0000
	void VehicleUpperBody(struct FPoseLink UpperInPose, struct FPoseLink& VehicleUpperBody); // Function 3RD_MAL_RIG_BedAnimBP.3RD_MAL_RIG_BedAnimBP_C.VehicleUpperBody // (HasOutParms|BlueprintCallable) // @ game+0x1be0000
	void AnimGraph(struct FPoseLink& AnimGraph); // Function 3RD_MAL_RIG_BedAnimBP.3RD_MAL_RIG_BedAnimBP_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1be0000
	void ExecuteUbergraph_3RD_MAL_RIG_BedAnimBP(int32_t EntryPoint); // Function 3RD_MAL_RIG_BedAnimBP.3RD_MAL_RIG_BedAnimBP_C.ExecuteUbergraph_3RD_MAL_RIG_BedAnimBP // (Final|UbergraphFunction) // @ game+0x1be0000
};
