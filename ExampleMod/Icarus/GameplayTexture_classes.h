...
struct UGameplayTexture : UObject {
	...
	struct UTexture2D* GetSourceTexture(); // Function GameplayTexture.GameplayTexture.GetSourceTexture // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0xb3cec0
};
