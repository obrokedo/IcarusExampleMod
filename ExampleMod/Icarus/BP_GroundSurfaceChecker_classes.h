...
struct UBP_GroundSurfaceChecker_C : USceneComponent {
	...
	void GetCurrentSurface(enum class EPhysicalSurface& Surface, float& WaterDepth, float& SlopeAngle); // Function BP_GroundSurfaceChecker.BP_GroundSurfaceChecker_C.GetCurrentSurface // (Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1be0000
};
