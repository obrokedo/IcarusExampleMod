...
struct U3RD_MAL_RIG_VehicleAnimBP_C : UAnimInstance {
	...
	void VehicleLowerBody(struct FPoseLink LowerInPose, struct FPoseLink& VehicleLowerBody); // Function 3RD_MAL_RIG_VehicleAnimBP.3RD_MAL_RIG_VehicleAnimBP_C.VehicleLowerBody // (HasOutParms|BlueprintCallable) // @ game+0x1be0000
	void VehicleUpperBody(struct FPoseLink UpperInPose, struct FPoseLink& VehicleUpperBody); // Function 3RD_MAL_RIG_VehicleAnimBP.3RD_MAL_RIG_VehicleAnimBP_C.VehicleUpperBody // (HasOutParms|BlueprintCallable) // @ game+0x1be0000
	void AnimGraph(struct FPoseLink& AnimGraph); // Function 3RD_MAL_RIG_VehicleAnimBP.3RD_MAL_RIG_VehicleAnimBP_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1be0000
	...
	void BlueprintUpdateAnimation(float DeltaTimeX); // Function 3RD_MAL_RIG_VehicleAnimBP.3RD_MAL_RIG_VehicleAnimBP_C.BlueprintUpdateAnimation // (Event|Public|BlueprintEvent) // @ game+0x1be0000
	void ExecuteUbergraph_3RD_MAL_RIG_VehicleAnimBP(int32_t EntryPoint); // Function 3RD_MAL_RIG_VehicleAnimBP.3RD_MAL_RIG_VehicleAnimBP_C.ExecuteUbergraph_3RD_MAL_RIG_VehicleAnimBP // (Final|UbergraphFunction|HasDefaults) // @ game+0x1be0000
};
