...
struct UUMG_GameMessageContainer_C : UUserWidget {
	...
	void AddMessage(bool Error, struct FText Message, float LifeTimeOverride); // Function UMG_GameMessageContainer.UMG_GameMessageContainer_C.AddMessage // (BlueprintCallable|BlueprintEvent) // @ game+0x1be0000
	void ExecuteUbergraph_UMG_GameMessageContainer(int32_t EntryPoint); // Function UMG_GameMessageContainer.UMG_GameMessageContainer_C.ExecuteUbergraph_UMG_GameMessageContainer // (Final|UbergraphFunction|HasDefaults) // @ game+0x1be0000
};
