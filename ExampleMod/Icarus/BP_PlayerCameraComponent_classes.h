...
struct UBP_PlayerCameraComponent_C : UActorComponent {
	...
	void UpdateCamera(struct FVector InLocation, struct FRotator InRotation, float InFOV, bool ForceUpdate, struct FVector& OutLocation, struct FRotator& OutRotation, float& OutFOV, bool& Return); // Function BP_PlayerCameraComponent.BP_PlayerCameraComponent_C.UpdateCamera // (Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1be0000
	bool UseFreeLookRotation(); // Function BP_PlayerCameraComponent.BP_PlayerCameraComponent_C.UseFreeLookRotation // (Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // @ game+0x1be0000
	void IsFirstPerson(bool& FirstPerson); // Function BP_PlayerCameraComponent.BP_PlayerCameraComponent_C.IsFirstPerson // (Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // @ game+0x1be0000
	void GetControllerRotation(struct FRotator& Rotation); // Function BP_PlayerCameraComponent.BP_PlayerCameraComponent_C.GetControllerRotation // (Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // @ game+0x1be0000
	void GetPlayer(struct ABP_IcarusPlayerCharacterSurvival_C*& Player); // Function BP_PlayerCameraComponent.BP_PlayerCameraComponent_C.GetPlayer // (Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // @ game+0x1be0000
	struct FVector CalculateAxisIndependentLag(struct FVector CurrentLocation, struct FVector TargetLocation, struct FRotator CameraRotation, struct FVector LagSpeeds, bool ForceUpdate); // Function BP_PlayerCameraComponent.BP_PlayerCameraComponent_C.CalculateAxisIndependentLag // (Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // @ game+0x1be0000
};
